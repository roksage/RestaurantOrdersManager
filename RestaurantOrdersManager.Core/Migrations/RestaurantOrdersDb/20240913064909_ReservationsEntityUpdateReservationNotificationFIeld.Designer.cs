...
namespace RestaurantOrdersManager.Core.Migrations.RestaurantOrdersDb
{
    ...
    [Migration("20240913064909_ReservationsEntityUpdateReservationNotificationFIeld")]
    partial class ReservationsEntityUpdateReservationNotificationFIeld
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RestaurantOrdersManager.Core.Entities.ReservationSystem.Reservation", b =>
                {
                    ...
                    b.Property<bool>("IsReservationNotificationSent")
                        .HasColumnType("bit");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2024, 9, 13, 11, 49, 8, 607, DateTimeKind.Local).AddTicks(678),
                            IsReservationNotificationSent = false,
                            PeopleCount = 0,
                            ReservationInfo = "Test Reservation",
                            ReservationStatus = 1,
                            StartTime = new DateTime(2024, 9, 13, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(677),
                            TableId = 2,
                            TimeCreated = new DateTime(2024, 9, 13, 6, 49, 8, 607, DateTimeKind.Utc).AddTicks(675),
                        ...
                        new
                        {
                            ReservationId = 21,
                            Email = "test@email.com",
                            EndTime = new DateTime(2024, 9, 13, 12, 49, 8, 607, DateTimeKind.Local).AddTicks(681),
                            IsReservationNotificationSent = false,
                            PeopleCount = 0,
                            ReservationInfo = "Test Reservation2",
                            ReservationStatus = 1,
                            StartTime = new DateTime(2024, 9, 13, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(681),
                            TableId = 2,
                            TimeCreated = new DateTime(2024, 9, 13, 6, 49, 8, 607, DateTimeKind.Utc).AddTicks(680),
            ...
            modelBuilder.Entity("RestaurantOrdersManager.Core.Entities.RestaurantOrders.MenuItemToOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MenuItemId = 1,
                            OrderId = 1,
                            ProcessStarted = new DateTime(2024, 9, 13, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(548)
                        },
                        new
                        {
                            OrderedMenuItemId = 2,
                            ...
                            MenuItemId = 2,
                            OrderId = 1,
                            ProcessStarted = new DateTime(2024, 9, 13, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(552)
                        },
                        new
                        {
                            OrderedMenuItemId = 3,
                            ...
                            MenuItemId = 3,
                            OrderId = 2,
                            ProcessStarted = new DateTime(2024, 9, 12, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(554)
                        },
                        new
                        {
                            OrderedMenuItemId = 4,
                            ...
                            MenuItemId = 4,
                            OrderId = 3,
                            ProcessStarted = new DateTime(2024, 9, 11, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(556)
                        },
                        new
                        {
                            OrderedMenuItemId = 5,
                            ...
                            MenuItemId = 5,
                            OrderId = 4,
                            ProcessStarted = new DateTime(2024, 9, 10, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(558)
                        },
                        new
                        {
                            OrderedMenuItemId = 6,
                            ...
                            MenuItemId = 6,
                            OrderId = 5,
                            ProcessStarted = new DateTime(2024, 9, 9, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(560)
                        },
                        new
                        {
                            OrderedMenuItemId = 7,
                            ...
                            MenuItemId = 7,
                            OrderId = 6,
                            ProcessStarted = new DateTime(2024, 9, 8, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(563)
                        },
                        new
                        {
                            OrderedMenuItemId = 8,
                            ...
                            MenuItemId = 8,
                            OrderId = 7,
                            ProcessStarted = new DateTime(2024, 9, 7, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(611)
                        },
                        new
                        {
                            OrderedMenuItemId = 9,
                            ...
                            MenuItemId = 9,
                            OrderId = 8,
                            ProcessStarted = new DateTime(2024, 9, 6, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(613)
                        },
                        new
                        {
                            ...
                            MenuItemId = 10,
                            OrderId = 9,
                            ProcessStarted = new DateTime(2024, 9, 5, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(615)
                        },
                        new
                        {
                            ...
                            MenuItemId = 1,
                            OrderId = 10,
                            ProcessStarted = new DateTime(2024, 9, 4, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(618)
                        },
                        new
                        {
                            ...
                            MenuItemId = 2,
                            OrderId = 10,
                            ProcessStarted = new DateTime(2024, 9, 4, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(620)
                        });
                });
            ...
            modelBuilder.Entity("RestaurantOrdersManager.Core.Entities.RestaurantOrders.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            TableId = 1,
                            TimeCreated = new DateTime(2024, 9, 13, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(503)
                        },
                        new
                        {
                            OrderId = 2,
                            CreatedBy = 2,
                            TableId = 1,
                            TimeCreated = new DateTime(2024, 9, 12, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(506)
                        },
                        new
                        {
                            OrderId = 3,
                            CreatedBy = 3,
                            TableId = 1,
                            TimeCreated = new DateTime(2024, 9, 11, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(512)
                        },
                        new
                        {
                            OrderId = 4,
                            CreatedBy = 1,
                            TableId = 2,
                            TimeCreated = new DateTime(2024, 9, 10, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(514)
                        },
                        new
                        {
                            OrderId = 5,
                            CreatedBy = 2,
                            TableId = 2,
                            TimeCreated = new DateTime(2024, 9, 9, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(516)
                        },
                        new
                        {
                            OrderId = 6,
                            CreatedBy = 3,
                            TableId = 3,
                            TimeCreated = new DateTime(2024, 9, 8, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(519)
                        },
                        new
                        {
                            OrderId = 7,
                            CreatedBy = 1,
                            TableId = 3,
                            TimeCreated = new DateTime(2024, 9, 7, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(521)
                        },
                        new
                        {
                            OrderId = 8,
                            CreatedBy = 2,
                            TableId = 4,
                            TimeCreated = new DateTime(2024, 9, 6, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(524)
                        },
                        new
                        {
                            OrderId = 9,
                            CreatedBy = 3,
                            TableId = 4,
                            TimeCreated = new DateTime(2024, 9, 5, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(526)
                        },
                        new
                        {
                            OrderId = 10,
                            CreatedBy = 1,
                            TableId = 5,
                            TimeCreated = new DateTime(2024, 9, 4, 9, 49, 8, 607, DateTimeKind.Local).AddTicks(528)
                        });
                });
